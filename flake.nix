{
  description = "v3-templater - {project-description}";
      ...
      in
      {
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P v3-templater.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/v3-templater $out/bin/  # Rust
            # cp bin/v3-templater $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/v3-templater";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-v3-templater" {
