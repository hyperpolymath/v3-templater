...
// Replace v3-templater, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= v3-templater — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining v3-templater for
...
* Upstream: https://github.com/hyperpolymath/v3-templater/issues
